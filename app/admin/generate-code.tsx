      ...
      <div className="w-full max-w-2xl p-8 rounded-2xl shadow-lg bg-white">
        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
          ...
          <div>
            ...
            <input type="number" min={1} max={10} className="w-full border rounded px-3 py-2 text-emerald-900 placeholder-emerald-700" value={usageLimit} onChange={e => setUsageLimit(Number(e.target.value))} required />
          </div>
